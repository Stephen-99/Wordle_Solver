...
def main():
    layout = [
        [sg.Button('', size=(5, 2), key=f'square{i}', button_color=('gray', 'gray')) for i in range(5)],
        [sg.Button('Exit')]
    ]
    ...
    while True:
        ...
        if event == sg.WINDOW_CLOSED or event == 'Exit':
            ...
            window[event].update(button_color=(square_colors[square_index], square_colors[square_index]))
    window.close()
