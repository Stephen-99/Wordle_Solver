...
class ListenerCreator:
    ...
    def SetupListeners(self, changeScreensFunc, updateGuiFunc, solver: WordleSolver, playWordleClient: PlayWordle, wordleRows: PlayWordleRows):
        self.listeners.append(ScreenManager(changeScreensFunc, updateGuiFunc, wordleRows))
